      ...
      <form onSubmit={search} className="flex gap-2 sm:gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 rounded-2xl bg-white border border-black/12 text-[#141414] text-[13px] placeholder-[#9B9B9B] focus:outline-none focus:border-[#FF4F00]/40 focus:ring-2 focus:ring-[#FF4F00]/10 transition-all"
