    ...
    <section id="about" className="relative py-24 overflow-hidden bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          >
            <p className="text-[12px] font-medium uppercase tracking-[0.08em] text-[#696F7B] mb-4">Why Choose Us</p>
        ...
        >
          {props.map((p) => (
            ...
            >
              ...
              <p className="text-[22px] text-[#696F7B] leading-[1.3]" style={{ fontFamily: "var(--font-heading)" }}>{p.desc}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
