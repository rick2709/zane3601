              ...
              <form onSubmit={subscribe} className="flex gap-2 w-full sm:w-auto">
                <div className="relative flex-1 sm:w-64">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-white/6 border border-white/10 text-white text-[13px] placeholder-white/25 focus:outline-none focus:border-[#FF4F00]/40 transition-all"
                  />
                </div>
                <motion.button
                  type="submit"
