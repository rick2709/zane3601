    ...
    <section id="domain-search" className="relative py-24 overflow-hidden bg-[#F7F7F7]">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#FF4F00]/20 bg-orange-50 text-[#FF4F00] text-[18px] font-medium mb-6">
              <Globe size={12} />
              500+ TLDs Available
            </div>
            ...
            <p className="mt-5 text-[18px] text-[#696F7B] leading-[1.3]">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {popularTLDs.map((tld) => (
              <span
                key={tld}
                className="px-3 py-1.5 rounded-full border border-black/10 bg-white text-[18px] font-medium text-[#696F7B]"
              >
                {tld}
              </span>
            ))}
          ...
          <a
            href="#pricing"
            className="inline-flex items-center gap-1.5 mt-6 text-[18px] text-[#FF4F00] hover:text-[#CC3F00] font-normal transition-colors group"
          >
