...
export default function CTABanner({
  ...
  subtitle = "Join 4,800+ businesses across 60+ countries who trust Zane360 with their domains and digital security. Setup takes under 5 minutes.",
  primary = { label: "Search Your Domain", href: "/domains" },
