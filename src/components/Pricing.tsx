    ...
    <section id="pricing" className="relative py-24 overflow-hidden bg-[#F7F7F7]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          >
            <p className="text-[12px] font-medium uppercase tracking-[0.08em] text-[#696F7B] mb-4">Pricing</p>
          ...
          {plans.map((plan, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="mb-6">
                  <h3 className={`text-[15px] font-normal mb-1 ${isOrange || isDark ? "text-white" : "text-[#141414]"}`} style={{ fontFamily: "var(--font-heading)" }}>
                    {plan.name}
                  </h3>
