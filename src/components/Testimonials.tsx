    ...
    <section id="testimonials" className="relative py-24 overflow-hidden bg-white">
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-14">
          ...
          >
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#9B9B9B] mb-4">Social Proof</p>
        ...
        <div className="relative min-h-[260px] sm:min-h-[220px]">
          <AnimatePresence mode="wait" custom={dir}>
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-[#141414] leading-relaxed mb-8">
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                  ...
                  />
                  <div>
                    <div className="font-semibold text-[#141414]" style={{ fontFamily: "var(--font-space-grotesk)" }}>
                      {testimonials[active].name}
                    </div>
                    <div className="text-sm text-[#9B9B9B]">{testimonials[active].role}</div>
                  </div>
                </div>
